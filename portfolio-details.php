        ...
        <div class="row gy-4">
            ...
            <div class="portfolio-details-slider swiper">
              <div class="swiper-wrapper align-items-center">
                ...
                <div class="swiper-slide">
                  <img src="assets/img/portfolio/compromiso-premiado.jpeg" alt="">
                </div>
          ...
          <div class="col-lg-4">
            <div class="portfolio-info">
              <h3>información</h3>
              <ul>
                <li><strong>Fecha:</strong> Noviembre del 2021</li>
                <li><strong>De:</strong> Municipalidad de Belén de Escobar</li>
                <li><strong>A:</strong> Jardín Santa María</li>
                <!-- <li><strong>Project URL</strong>: <a href="#">www.example.com</a></li> -->
              </ul>
            </div>
            <div class="portfolio-description">
              <h2>¡Fuimos distinguidos!</h2>
              <p>Por haber contribuido a promover la integración de la educación y gestión ambiental en el marco del programa "Escuelas por el ambiente".
                <br>
                <br>
                <br>
                se puede contar más<br>
                Se pueden subir más fotos o dejar solo una.<br>
                Modelo de un tipo de mensaje
              </p>
            </div>
          </div>
